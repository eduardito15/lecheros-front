...
class SalesByClientComponent extends React.Component {
    ...
    handleSearch() {
        ...
        ReportsService.salesByClient(this.state.searchFromDate, this.state.searchToDate, this.state.selectedClient)
        .then(
            (response) => {
                        ...
                        {this.state.showFailedDialog ?
                            <div>
                                <FailedDialog showFailedDialog={this.state.showFailedDialog}
                                    ...
                                    resultDialogMessage={this.state.resultDialogMessage} title='Compras por Cliente' />
                            </div> : ''
                        }
                    </div>
                }
...
export default withStyles(useStyles)(SalesByClientComponent);
