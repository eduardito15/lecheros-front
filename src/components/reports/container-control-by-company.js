...
class ContainerControlByCompanyComponent extends React.Component {
    ...
    handleSearch() {
        ...
        ReportsService.getContainerControlByCompanyReport(this.state.searchFromDate, this.state.searchToDate, this.state.searchDelivery)
            .then(
                (response) => {
                ...
                {this.state.showFailedDialog ?
                    <div>
                        <FailedDialog showFailedDialog={this.state.showFailedDialog}
                                      ...
                                      resultDialogMessage={this.state.resultDialogMessage} title='Control de Envases por Empresa'/>
                    </div> : ''
                }
            </div>
            }
...
export default withStyles(useStyles)(ContainerControlByCompanyComponent);
