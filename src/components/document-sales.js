...
class DocumentSales extends React.Component {
    ...
    handleFormClose() {
        if (this.state.documentCreated && this.state.selectedNumber != null && this.state.selectedNumber !== '') {
                        ...
                        {this.state.showForm ?
                            <div>
                                <DocumentForm open={this.state.showForm} handleClose={this.handleFormClose}
                                              ...
                                              documentCreated={this.state.documentCreated}
                                />
                            </div> : ''
                        }
                    </div>
...
export default withStyles(useStyles)(DocumentSales);
